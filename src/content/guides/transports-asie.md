---
title: "Transports en Asie : trains, bus, ferries et vols intérieurs"
heading: "Se déplacer en Asie : ce qui vaut le coup, ce qui fait perdre une journée"
...
faq:
  ...
  - q: "Faut-il acheter le JR Pass au Japon ?"
    r: "Depuis la hausse tarifaire, il n'est plus rentable par défaut. Un aller-retour Tokyo–Kyoto avec une extension vers Hiroshima l'amortit tout juste. Faites le calcul trajet par trajet sur les tarifs réels avant d'acheter : dans la majorité des itinéraires classiques, acheter les billets à l'unité revient moins cher."
  - q: "Combien de temps prévoir entre deux vols intérieurs aux Philippines ?"
    r: "Trois heures minimum, et davantage si le second vol est le dernier de la journée. Les retards sont structurels, particulièrement de juin à novembre, et les compagnies low cost n'ont aucune obligation de reroutage sur une correspondance non protégée."
  - q: "Peut-on louer un scooter en Asie sans permis moto ?"
    r: "Physiquement oui, légalement non, et cela vous laisse sans aucune couverture d'assurance. Un accident sans permis A ou A1 valide et sans permis international signifie que les frais médicaux, le rapatriement et les dommages causés à un tiers restent intégralement à votre charge. C'est la première cause de sinistre non couvert en Asie du Sud-Est."
---

Les transports sont le poste où les voyageurs perdent le plus de temps — non pas parce que l'Asie est mal desservie, mais parce que la carte ment. Deux cents kilomètres de plaine au Vietnam, c'est quatre heures. Deux cents kilomètres de montagne au Laos, c'est sept.
...
Pour les réservations terrestres en Asie du Sud-Est, [12Go](https://12go.asia) est l'agrégateur le plus fiable, avec des horaires réels et des opérateurs identifiés — ce que les guichets locaux ne fournissent pas toujours en anglais.
...
- Vérifiez que votre [assurance](/assurances-voyage) couvre explicitement la conduite d'un deux-roues.
...
Le seul prérequis : un numéro local, ou un compte créé avant le départ. Voir le [guide eSIM](/esim-asie).
