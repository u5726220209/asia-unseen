---
title: "Les applications vraiment utiles pour voyager en Asie"
heading: "Les applications qui servent en Asie, et celles qui ne servent à rien"
description: "Quelles applications installer avant de partir en Asie : VTC, cartes hors ligne, traduction, paiement, transports. Une par usage, sans liste à rallonge."
accroche: "Six applications suffisent. Toutes les autres sont soit redondantes, soit inutiles hors de chez vous — et deux d'entre elles doivent impérativement être installées avant le décollage."
pubDate: 2026-07-04
categorie: pratique
...
faq:
  ...
  - q: "Google Maps fonctionne-t-il en Asie ?"
    r: "Oui partout, sauf en Chine continentale où il est inaccessible sans VPN et où les données cartographiques sont de toute façon décalées. En Corée du Sud, il fonctionne mais l'itinéraire piéton et les transports sont très incomplets : les applications coréennes sont nettement meilleures."
  - q: "Quelles applications installer avant de partir, obligatoirement ?"
    r: "Un VPN si vous allez en Chine, et le traducteur en mode hors ligne avec la langue de destination téléchargée. Les deux nécessitent un accès à Internet et aux magasins d'applications pour être installés — un accès qui est justement filtré ou coupé au moment où vous en auriez besoin."
---

Les listes de « 30 applications indispensables pour voyager » sont un genre en soi, et elles sont toutes fausses : personne n'utilise trente applications en voyage. Voici les six qui servent réellement, une par usage, et l'ordre dans lequel les installer.
...
**Le prérequis :** un numéro de téléphone pour la vérification. Certaines acceptent un numéro français, d'autres exigent un numéro local — raison de plus pour lire le [guide eSIM](/esim-asie) avant de partir.
...
Pour réserver trains, bus et ferries en Asie du Sud-Est, un seul agrégateur fait le travail correctement : [12Go](https://12go.asia). Horaires réels, opérateurs identifiés, billets en anglais — ce que les guichets locaux ne fournissent pas toujours.

Au Japon et en Corée, les applications ferroviaires nationales suffisent largement. En Chine, la réservation des trains à grande vitesse se fait via les plateformes officielles, dix à quinze jours à l'avance : c'est le point à ne pas rater, détaillé dans le [guide Chine](/chine).
...
Le reste des questions d'argent — cartes sans frais, retraits, change — est dans le [guide argent et banques](/banques-asie).
...
1. Souscrire et installer sur le téléphone **et** l'ordinateur.
2. Le tester en se connectant à un serveur hors de Chine.
3. En installer un deuxième, d'un autre fournisseur — les VPN sont régulièrement bloqués.
4. Noter les identifiants ailleurs que dans un gestionnaire qui aurait besoin de se synchroniser.
...
- [ ] eSIM installée mais **pas encore activée** — voir le [guide eSIM](/esim-asie)
