---
title: "Scooter en Asie : ce que couvre vraiment l'assurance"
heading: "Louer un scooter en Asie : ce que votre assurance couvre, et ce qu'elle ne couvre pas"
description: "Permis A1, permis international, casque : les conditions réelles pour être couvert en scooter en Asie. Pourquoi la formation 125 française ne suffit pas."
accroche: "Le loueur ne vous demandera rien. Votre assureur, lui, vérifiera tout — et c'est à ce moment-là que se joue la différence entre une facture de 200 € et une de 60 000 €."
pubDate: 2026-08-30
categorie: pratique
...
faq:
  ...
  - q: "Le permis international suffit-il pour louer un scooter en Asie ?"
    r: "Il est nécessaire mais pas suffisant. Le permis international ne fait que traduire votre permis national : si votre permis national ne comporte pas la catégorie A ou A1, le permis international ne la comportera pas non plus. Les deux documents doivent être présentés ensemble."
  - q: "Que se passe-t-il en cas d'accident sans le bon permis ?"
    r: "L'assureur peut refuser tout ou partie de la prise en charge : frais médicaux, rapatriement sanitaire et dommages causés à un tiers restent alors à votre charge. Un rapatriement médicalisé depuis l'Asie du Sud-Est se situe entre 20 000 et 80 000 €. C'est la première cause de sinistre non couvert pour les voyageurs français dans la région."
  - q: "Les loueurs vérifient-ils le permis en Asie ?"
    r: "Rarement, et c'est précisément le piège. La facilité de location n'a aucun rapport avec votre couverture d'assurance : un loueur qui ne demande rien ne vous rend pas légalement autorisé à conduire, et n'engage pas votre assureur."
---

C'est le sujet sur lequel ce site est le moins nuancé, parce que les chiffres ne le permettent pas. Les accidents de deux-roues sont de très loin la première cause d'hospitalisation et de rapatriement de voyageurs français en Asie du Sud-Est.
...
1. **Un permis A ou A1**, correspondant à la cylindrée conduite. Le permis B ne suffit pas au-delà de 50 cm³ — et la quasi-totalité des scooters loués en Asie font 110 à 150 cm³.
2. **Un permis international** mentionnant la catégorie A ou A1. Il est gratuit, se demande en ligne, et prend plusieurs semaines : ce n'est pas une formalité de dernière minute.
3. **Un contrat d'assurance qui couvre explicitement la conduite d'un deux-roues motorisé.** Certains contrats les excluent totalement, d'autres plafonnent selon la cylindrée.

Les critères de choix d'un contrat — plafond médical, avance de frais, exclusions — sont détaillés dans le [guide des assurances voyage](/assurances-voyage).
...
Face à ça, un permis A1 passé avant le départ et un contrat d'assurance à 50 € pour trois semaines constituent le meilleur rapport de tout votre budget. Les fourchettes complètes sont dans le [guide budget](/budget-voyage-asie).
...
- **Ne laissez jamais votre passeport en caution.** Une photocopie, ou une avance en espèces. Récupérer un passeport après un litige peut prendre des jours — le sujet est traité dans les [20 erreurs à éviter](/erreurs-a-eviter).
...
Si vous n'avez pas d'expérience réelle de la moto en montagne, **prenez un pilote local**. Vous serez passager, vous regarderez le paysage au lieu du bitume, et la question de l'assurance ne se pose plus dans les mêmes termes. Le détail, sur l'exemple de Ha Giang, est dans [l'article dédié](/blog/ha-giang-moto-4-jours).
