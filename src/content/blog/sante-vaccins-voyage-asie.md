---
title: "Santé et vaccins pour l'Asie : ce qu'il faut préparer"
heading: "Santé en Asie : ce qu'il faut préparer, et quand s'y prendre"
description: "Vaccins, trousse à pharmacie, eau, moustiques : comment préparer un voyage en Asie côté santé, avec le calendrier des démarches et les sources officielles."
accroche: "Certains vaccins demandent trois rendez-vous étalés sur un mois. C'est la seule raison pour laquelle ce sujet doit être traité six semaines avant le départ, pas la veille."
pubDate: 2026-07-08
categorie: pratique
...
faq:
  ...
  - q: "Quand faut-il s'occuper des vaccins avant de partir ?"
    r: "Six à huit semaines avant le départ. Certains schémas vaccinaux demandent deux ou trois injections espacées, et l'immunité n'est pas immédiate. S'y prendre à deux semaines du départ, c'est se retrouver avec une protection incomplète."
  - q: "Peut-on boire l'eau du robinet en Asie ?"
    r: "Non dans la plupart des pays d'Asie du Sud-Est. Le Japon, la Corée du Sud, Singapour et Hong Kong font exception. Ailleurs, eau en bouteille scellée, eau filtrée par votre hébergement, ou gourde filtrante. La règle vaut aussi pour les glaçons dans les zones rurales et pour le brossage de dents en cas d'estomac fragile."
  - q: "Que mettre dans une trousse à pharmacie pour l'Asie ?"
...
Ce sujet a une particularité : c'est le seul de la préparation d'un voyage qui a un **délai incompressible**. Un visa se demande en trois jours, un vol se réserve en dix minutes, mais un schéma vaccinal en trois injections prend un mois.
...
- **[France Diplomatie](https://www.diplomatie.gouv.fr/fr/conseils-aux-voyageurs/)** — la fiche « santé » de chaque pays, mise à jour par le ministère.
...
Les critères à vérifier — plafond, avance de frais, exclusions liées aux deux-roues — sont détaillés dans le [guide des assurances voyage](/assurances-voyage). C'est la partie de ce sujet où l'on peut vraiment se tromper.
